...
export function recalcPbItems(data) {
  ...
  var autoMap = {
    ...
    "2.01.01.01": (t025 + ep2.v025 + sumExcTot) * pT * pAL, "2.01.01.02": (t2550 + ep2.v2550) * pT * pAL, "2.01.01.04": (t025 + ep2.v025 + sumExcTot) * pG * pAL, "2.01.01.05": (t2550 + ep2.v2550) * pG * pAL, "2.01.01.07": (t025 + t2550 + t50p + ep2.tVE + sumExcTot) * pR * pAL,
    "2.01.02.01": (t025 + ep2.v025 + sumExcTot) * pT * (1 - pAL), "2.01.02.02": (t2550 + ep2.v2550) * pT * (1 - pAL), "2.01.02.04": (t025 + ep2.v025 + sumExcTot) * pG * (1 - pAL), "2.01.02.05": (t2550 + ep2.v2550) * pG * (1 - pAL), "2.01.02.07": (t025 + t2550 + t50p + ep2.tVE + sumExcTot) * pR * (1 - pAL),
